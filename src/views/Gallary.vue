...
export default {
  data: () => ({
    ...
    imgs: [
      ...
      require('@/assets/img/7, 뫼즈강의 맥주(Bieres de La Meuse), 1897.jpeg'),
      require('@/assets/img/8, 모나코 몬테 카를로(Monaco - Monte Carlo), 1897.jpeg'),
      require('@/assets/img/9, 장식 패널 앵초와 깃털을 위한 디자인( The Primrose and the Quill), 1899.png'),
      require('@/assets/img/10, 뿌리는 향수 로도 광고 포스터 (Lanca Perfume “Rodo”), 1896.jpeg'),
      require('@/assets/img/11, 호르이체에서 열린 북동 보헤이마의 상공 예술 박람회를 위한 포스터(Hospodarska Prumyslova a umelecka Vystava Ceskeho Severovychodu v Horicich, 1903.jpg'),
      require('@/assets/img/12, 세인트루이스 만국 박람회를 위한 홍보 포스터(art nouveau color lithograph poster showing a seated woman clasping the hand of a Native american), 1903.jpg'),
      require('@/assets/img/13, 잔다르크로 분한 모드 아담(Maude Adams as Joan of Arc), 1908.jpg'),
      require('@/assets/img/14, 모리비아 교사 합창단을 위한 포스터(Moravian Teachers Choir), 1911.jpg'),
      require('@/assets/img/15, 슬라브 서사시 연작 중 슬라브 민족의 역사 찬미(Epopeia Eslava - Ciclo XX), 1926.jpg'),
    ],
  }),
