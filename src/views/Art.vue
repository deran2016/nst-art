<template>
  ...
  >
    ...
    <v-card-text>
      ...
      <div class="px-8 body-2">
        # 작품 정보 팝업창을 종료하시려면 팝업창 우측하단의 닫기 버튼이나 팝업창 밖을 클릭해주세요.
      </div>
  ...
  data: () => ({
    ...
    artInfo: {
      ...
      img3: {
        ...
        text: '이 작품은 당시 파리에서 가장 유명한 배우였던 사라 베르나르의 극 중 하나인 토스카의 포스터이다. 무하는 1895년 베르나르의 연극 지스몽다 포스터로 큰 성공을 거둔 후, 그녀와 계약을 채결했다. 무하는 이후 6년간 그녀를 위한 포스터를 제작하고 연극 콘셉과 디자인을 도맡는 동업자가 되었다. 이 작품에는 주인공 플로리아 토스카를 맡아 연기하는 사라 베르나르의 모습이 담겨있다. <br/><br/>배경에 들어간 기하학적이고 반복적인 무늬는 무하의 작품에 빠짐없이 등장하는 장식적인 요소로, 동시대의 아카데미 예술에 비하면 평면적이지만, 실용적이면서 아름다운 자연의 무늬를 추구하는 아르누보 양식에 큰 영향을 주었다. 이러한 무하의 양식은 그가 제작한 포스터를 통해 프랑스 전역을 거쳐 미국에까지 이어져, 훗날 가구나 악세사리 디자인 등에서 무하 스타일을 찾아볼 수 있게 된다. 이는 무하의 그림이 캔버스에 유화로 그려진 것이 아니라 채색 석판화로 복사 가능하게 만들어져, 쉽게 퍼져나갈 수 있는 특징을 가졌기 때문이기도 하다.',
      },
      img4: {
