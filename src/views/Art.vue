...
export default {
  ...
  data: () => ({
    ...
    artInfo: {
      ...
      img7: {
        title: '일세, 트리폴리 공주를 위한 삽화, 1897',
      ...
      img8: {
        title: '르 파테를 위한 삽화, 1899',
      ...
      img11: {
        title: '파리 만국 박람회 오스트리아 전시관 포스터(Exposition universelle de paris), 1899',
